...
<!--Dijkstra's implemented on a heap gives $\mathcal{O}(\text{number of edges} ~\cdot~ log(\text{number of nodes}))$-->
...
Instead it has different applications (e.g. topological ordering)
